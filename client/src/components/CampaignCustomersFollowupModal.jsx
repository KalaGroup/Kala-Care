                ...
                <div className="relative w-screen h-screen max-w-none bg-white shadow-2xl overflow-hidden rounded-none">
                    ...
                    <div className="px-3 sm:px-5 py-2 border-b border-gray-200 bg-white flex flex-col sm:flex-row justify-between items-center gap-2">
                        <div className="relative w-full sm:w-72 md:w-80">
                            <input
                                ...
                                className="w-full pl-8 pr-7 py-1.5 text-xs border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2f3192]/20 focus:border-[#2f3192] transition-all text-black"
                            />
                    ...
                    <div className="relative bg-gray-50">
                        ...
                        <div
                            ...
                            style={{ maxHeight: 'calc(100vh - 300px)', minHeight: '450px', overflowX: 'auto' }}
                        >
                            {loading ? (
